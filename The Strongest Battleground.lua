...
local Window = Library:MakeWindow({
    Title = "FREE FIRE HUB | " .. Version,
    SaveFolder = "FREE FIRE HUB"
...
Home:AddDiscordInvite({
    Name = "FREE FIRE HUB | Official Server",
    Logo = "rbxassetid://127393374937080",
    Invite = Discord
})
local SpeedHubX = {}
...
local Farming = Window:MakeTab({"Farming", "rbxassetid://127393374937080"})
...
local Killer = Window:MakeTab({"Killer", "rbxassetid://127393374937080"})
